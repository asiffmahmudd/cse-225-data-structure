...
template<class ItemType>
int CountNodes (TreeType<ItemType>* tree)
{
    if(tree == NULL)
        return 0;
    else
...
template<class ItemType>
void Retrieve(TreeType<ItemType>* tree, ItemType& item, bool& found)
{
    if(tree == NULL)
        found  = false;
...
template<class ItemType>
void Insert(TreeType<ItemType>*& tree, ItemType item)
{
    if(tree == NULL){
...
template<class ItemType>
void Delete(TreeType<ItemType>*& tree, ItemType item)
{
...
template<class ItemType>
void GetPredecessor(TreeType<ItemType>* tree, ItemType& data)
{
...
template<class ItemType>
void PrintTree(TreeType<ItemType>* tree)
{
    if(tree != NULL){
        PrintTree(tree->left);
        cout << tree->info << " ";
